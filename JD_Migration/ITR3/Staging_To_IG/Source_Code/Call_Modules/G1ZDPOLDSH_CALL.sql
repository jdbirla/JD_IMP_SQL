...
spool "&SQL_LOG_PATH.\G1ZDPOLDSH_CALL_&log_date_text..txt"
...
--Actual Migration: Please set I_ZPRVALDYN='N' if you want to do actual migration
...
DECLARE
  ...
  I_REMARKS VARCHAR2(500 CHAR):= 'Policy Dishonour Count Testing by sql';
  BEGIN
BEGIN
SELECT table_name
...
END;
/
@C:\D_Drive\Zurich_Product\PA_Data_Migration\integral-CustomerZurichJpnDM\Documentation\DataChange\Oracle\Phase-2\ITR3\Staging_To_IG\Source_Code\DM_01_OverALL_DM\DM2_BATCH_MONITOR.sql '&I_SCHEDULENAME' '&v_schedulenumber';
/
@C:\D_Drive\Zurich_Product\PA_Data_Migration\integral-CustomerZurichJpnDM\Documentation\DataChange\Oracle\Phase-2\ITR3\Staging_To_IG\Source_Code\DM_01_OverALL_DM\DM2_ZDOE_REPORT.sql '&I_SCHEDULENAME' '&v_schedulenumber' TITDMGMBRINDP3 PD;
/
...
END;
/
@C:\D_Drive\Zurich_Product\PA_Data_Migration\integral-CustomerZurichJpnDM\Documentation\DataChange\Oracle\Phase-2\ITR3\Staging_To_IG\Source_Code\DM_01_OverALL_DM\DM2_POST_VAL_STATS.sql '&I_SCHEDULENAME' '&v_schedulenumber';
/
*/
