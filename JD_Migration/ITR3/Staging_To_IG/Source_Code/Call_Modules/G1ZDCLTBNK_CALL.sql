/*
  PA Data Migration G1ZDCLTBNK_CALL
*/
...
select 'G1ZDCLTBNK' as SCHEDULENAME from dual;
...
spool "&SQL_LOG_PATH.\G1ZDCLTBNK_CALL_&log_date_text..txt"
...
DECLARE
  ...
  I_SCHEDULENAME VARCHAR2(50 CHAR) := 'G1ZDCLTBNK';
...
/
@DM2_ZDOE_REPORT.sql '&I_SCHEDULENAME' '&v_schedulenumber' TITDMGCLNTBANK CB;
/
...
BEGIN
 ...
 Jd1dta.PV_CB_G1ZDCLTBNK(i_schedulename =>I_SCHEDULENAME,
                  i_schedulenumber => V_SCHEDULENUMBER);
END;
/
