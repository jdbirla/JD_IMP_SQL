/*
  PA Data Migration G1ZDPERCLT_CALL
*/
...
select 'G1ZDPERCLT' as SCHEDULENAME from dual;
...
spool "&SQL_LOG_PATH.\G1ZDPERCLT_CALL_&log_date_text..txt"
...
DECLARE
  ...
  I_SCHEDULENAME VARCHAR2(50 CHAR) := 'G1ZDPERCLT';
...
/
@DM2_ZDOE_REPORT.sql '&I_SCHEDULENAME' '&v_schedulenumber' TITDMGCLTRNHIS CP;
/
...
BEGIN
 ...
 Jd1dta.PV_CP_G1ZDPERCLT(i_schedulename =>I_SCHEDULENAME,
                  i_schedulenumber => V_SCHEDULENUMBER);
END;
/
