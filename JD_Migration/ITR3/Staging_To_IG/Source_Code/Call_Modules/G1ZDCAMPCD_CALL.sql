/*
  PA Data Migration G1ZDCAMPCD_CALL
*/
...
select 'G1ZDCAMPCD' as SCHEDULENAME from dual;
...
spool "&SQL_LOG_PATH.\G1ZDCAMPCD_CALL_&log_date_text..txt"
...
DECLARE
  ...
  I_SCHEDULENAME VARCHAR2(50 CHAR) := 'G1ZDCAMPCD';
  I_ZPRVALDYN VARCHAR2(1 Char):= '&1';
  I_REMARKS VARCHAR2(500 CHAR):= 'campcode Testing by sql';
  BEGIN
BEGIN
SELECT table_name
...
/
@DM2_ZDOE_REPORT.sql '&I_SCHEDULENAME' '&v_schedulenumber' TITDMGCAMPCDE CM;
/
/*
DECLARE
 I_SCHEDULENAME VARCHAR2(50 CHAR) := 'G1ZDCAMPCD';
