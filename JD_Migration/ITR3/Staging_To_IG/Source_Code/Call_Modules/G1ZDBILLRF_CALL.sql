/*
  PA Data Migration G1ZDBILLRF_CALL
*/


--DEFINE SQL_LOG_PATH = "C:\DM_Testing\DM2_Migration_Stag_to_IG\Execution\Logs"
...
select 'G1ZDBILLRF' as SCHEDULENAME from dual;
...
spool "&SQL_LOG_PATH.\G1ZDBILLRF_CALL_&log_date_text..txt"
...
/* step 0:Please check table DMBARGSPF(Data migration argument) it contains the arguments for each shcedule, 
  ...
  select * from DMBARGSPF where SCHEDULE_NAME='G1ZDBILLRF';
...
DECLARE
  ...
  I_SCHEDULENAME VARCHAR2(50 CHAR) := 'G1ZDBILLRF';
  I_ZPRVALDYN VARCHAR2(1 Char):= '&1';
  I_REMARKS VARCHAR2(500 CHAR):= 'Billing Refund Testing';
  BEGIN
BEGIN
SELECT table_name
...
END;
/
--@C:\DM_Testing\DM2_Migration_Stag_to_IG\DM_01_OverALL_DM\DM2_BATCH_MONITOR.sql '&I_SCHEDULENAME' '&v_schedulenumber';
@DM2_BATCH_MONITOR.sql '&I_SCHEDULENAME' '&v_schedulenumber';
/
--@C:\DM_Testing\DM2_Migration_Stag_to_IG\DM_01_OverALL_DM\DM2_ZDOE_REPORT_2TAB.sql '&I_SCHEDULENAME' '&v_schedulenumber' TITDMGREF1 TITDMGREF2 RF;
@DM2_ZDOE_REPORT_2TAB.sql '&I_SCHEDULENAME' '&v_schedulenumber' TITDMGREF1 TITDMGREF2 RF;
...
BEGIN
 ...
 Jd1dta.PV_BL_G1ZDBILLRF(i_schedulename =>I_SCHEDULENAME,
                  i_schedulenumber => V_SCHEDULENUMBER);
END;
/
