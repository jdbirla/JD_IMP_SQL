/*
  PA Data Migration G1ZDNAYCLT_CALL ITR3
*/
...
select 'G1ZDNAYCLT' as SCHEDULENAME from dual;
...
spool "&SQL_LOG_PATH.\G1ZDNAYCLT_CALL_&log_date_text..txt"
...
---Actual Migration: Please set I_ZPRVALDYN='N' if you want to do only pre validation
...
DECLARE
  ...
  I_SCHEDULENAME VARCHAR2(50 CHAR) := 'G1ZDNAYCLT';
  I_ZPRVALDYN VARCHAR2(1 Char):= '&1';
  I_REMARKS VARCHAR2(500 CHAR):= 'Personal client  Testing by sql';
  BEGIN
BEGIN
SELECT table_name
...
/
@DM2_ZDOE_REPORT.sql '&I_SCHEDULENAME' '&v_schedulenumber' DMIGTITNYCLT NY;
/
