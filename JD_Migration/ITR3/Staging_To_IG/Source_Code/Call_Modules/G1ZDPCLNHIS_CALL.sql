/*
  PA Data Migration G1ZDPCLHIS_CALL
*/
...
select 'G1ZDPCLHIS' as SCHEDULENAME from dual;
...
spool "&SQL_LOG_PATH.\G1ZDPCLHIS_CALL_&log_date_text..txt"
...
DECLARE
  ...
  I_SCHEDULENAME VARCHAR2(50 CHAR) := 'G1ZDPCLHIS';
...
/
@DM2_ZDOE_REPORT.sql '&I_SCHEDULENAME' '&v_schedulenumber' TITDMGCLTRNHIS CH;
/
...
BEGIN
 ...
 Jd1dta.PV_CH_G1ZDPCLHIS(i_schedulename =>I_SCHEDULENAME,
                  i_schedulenumber => V_SCHEDULENUMBER);
END;
/
