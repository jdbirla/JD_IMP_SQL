/*
  PA Data Migration G1ZDBILLIN_CALL
*/

--DEFINE SQL_LOG_PATH = "C:\ZurichDM\Execution\Logs"
...
select 'G1ZDBILLIN' as SCHEDULENAME from dual;
...
spool "&SQL_LOG_PATH.\G1ZDBILLIN_CALL_&log_date_text..txt"
...
---Actual Migration: Please set I_ZPRVALDYN='N' if you want to do both pre validation and migration
...
DECLARE
  ...
  I_SCHEDULENAME VARCHAR2(50 CHAR) := 'G1ZDBILLIN';
  I_ZPRVALDYN VARCHAR2(1 Char):= '&1';
  I_REMARKS VARCHAR2(500 CHAR):= 'Billing Testing by sql';
...
/
@DM2_ZDOE_REPORT_2TAB.sql '&I_SCHEDULENAME' '&v_schedulenumber' TITDMGBILL1 TITDMGBILL2 BL;
/
...
BEGIN
  ...
  Jd1dta.PV_BL_G1ZDBILLIN(i_schedulename => I_SCHEDULENAME,
                          i_schedulenumber => V_SCHEDULENUMBER);
END;
/
