/**********************************************************************************************************************
  * File Name        : G1ZDLETR_CALL
  * Author           : Bhupendra Singh
  * Creation Date    : Aug 12, 2020
  * Project          : -----
  -----(formerly jdc Technologies India Private Limited)
  * Description      : This Procedure is for call parallel run for Letter module
  **************************************************************************************************************************/
   /***************************************************************************************************
...
/*
  PA Data Migration G1ZDLETR_CALL
*/
...
select 'G1ZDLETR' as SCHEDULENAME from dual;
...
spool "&SQL_LOG_PATH.\G1ZDLETR_CALL_&log_date_text..txt"
...
DECLARE
  ...
  I_SCHEDULENAME VARCHAR2(50 CHAR) := 'G1ZDLETR';
  I_ZPRVALDYN VARCHAR2(1 Char):= '&1';
  I_REMARKS VARCHAR2(500 CHAR):= 'Letter Testing by sql';
  BEGIN
BEGIN
SELECT table_name
...
/
@DM2_ZDOE_REPORT.sql '&I_SCHEDULENAME' '&v_schedulenumber' TITDMGLETTER LT;
/
...
BEGIN
 ...
 Jd1dta.PV_LT_G1ZDLETR(i_schedulename =>I_SCHEDULENAME,
                  i_schedulenumber => V_SCHEDULENUMBER);
END;
/
