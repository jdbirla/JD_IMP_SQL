...
(
  ...
  (
    ...
    BADFILE 'EXT_DATA_DIR':'TOTPAMMISCLN_EXT.bad'
    LOGFILE 'TOTPAMMISCLN_EXT.log_xt'
    READSIZE 1048576
    FIELDS TERMINATED BY ","  
    REJECT ROWS WITH ALL NULL FIELDS 
    (
   
		  "RECIDXCLNT"  CHAR(255)   TERMINATED BY "," ENCLOSED BY '"',
  ...
  location 
  (
    '/opt/ig/hitoku/user/output/outputTOTPAMMISCLN.csv'
  )
)REJECT LIMIT UNLIMITED;
/

--drop table TOTPAMMISCLN_EXT;

--select * from TOTPAMMISCLN_EXT; 