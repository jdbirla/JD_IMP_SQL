...
/opt/ig/hitoku/user/bin/ZCLEPF_Mask.sh
...
#------------ Added in PA-------------------
/opt/ig/hitoku/user/bin/ZBENFDTLSPF_Mask.sh
#/opt/ig/hitoku/user/bin/ZIIRPF_Mask.sh
/opt/ig/hitoku/user/bin/ZINSDTLSPF_Mask.sh
/opt/ig/hitoku/user/bin/ZIRHPF_Mask.sh
/opt/ig/hitoku/user/bin/ZIRDPF_Mask.sh
